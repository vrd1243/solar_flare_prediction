...
df = pd.read_csv("~/solar-flares/datasets/stacked_small_dataset.csv", sep=",", header='infer')
print(df.head())
print(df.columns)
sunspotTrainSet, sunspotValidSet = DataProcessing.generateTrainValidData(df, root_dir='/', splitType='by_harpnum')
