...
def createLossAndOptimizer(net, learning_rate, weight):
    ...
    #Optimizer
    optimizer = optim.Adagrad(net.parameters(), lr=learning_rate, weight_decay=0.01, lr_decay=1e-4)
...
def trainNet(net, batch_size, n_epochs, learning_rate):
    ...
    np.save('stats', np.concatenate((train_plot, valid_plot, tss_plot, tp_plot, fp_plot, tn_plot, fn_plot), axis = 1)) 
    plt.figure()
...
trainNet(CNN, batch_size=128, n_epochs=15, learning_rate=1e-3)
